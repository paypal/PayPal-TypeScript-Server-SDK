...
import { PaResStatus, paResStatusSchema } from './paResStatus.js';
...
export const threeDSecureCardAuthenticationResponseSchema: Schema<ThreeDSecureCardAuthenticationResponse> = object(
  {
