...
export interface PhoneNumberWithOptionalCountryCode {
...
export const phoneNumberWithOptionalCountryCodeSchema: Schema<PhoneNumberWithOptionalCountryCode> = object(
  {
