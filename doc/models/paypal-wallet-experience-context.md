...
| `userAction` | [`PaypalExperienceUserAction \| undefined`](../../doc/models/paypal-experience-user-action.md) | Optional | Configures a Continue or Pay Now checkout flow.<br>**Default**: `PaypalExperienceUserAction.Continue`<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `8`, *Pattern*: `^[0-9A-Z_]+$` |
